...
public class TheAutomata {
    ...
    public void addChars(String currentState, char startChar, char endChar, String nextState) {
        for (char c = startChar; c <= endChar; c++) {
            addTransition(currentState, String.valueOf(c), nextState);
        }
    }

    public void addNumbers(String currentState, char startNum, char endNum, String nextState) {
        addChars(currentState, startNum, endNum, nextState);
    }
